...
%global pkg_name gurumdds_cmake_module
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-gurumdds-cmake-module
Version:        7.0.0
Release:        3%{?dist}
...
%changelog
* Mon Aug 31 2026 Donghyeon Lee <donghyeon@gurum.cc> - 7.0.0-3
- Autogenerated by Bloom

* Mon Aug 31 2026 Donghyeon Lee <donghyeon@gurum.cc> - 7.0.0-2
- Autogenerated by Bloom

* Thu Jun 18 2026 Donghyeon Lee <donghyeon@gurum.cc> - 7.0.0-1
- Autogenerated by Bloom
